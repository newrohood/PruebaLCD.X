...
//Ejemplo EscribeLCD_n16(12754,5);	
	...
	switch(b){
		...
		case 2:	decena=(a%100)/10;
				...
				RetardoLCD(4);
				break;
		case 3: decena=(a%100)/10;
				unidad=a%10;
				EscribeLCD_n8((a%1000)/100,1);
				EnviaDato(decena+48);
				HabilitaLCD();
				RetardoLCD(4);
				EnviaDato(unidad+48);
				...
				RetardoLCD(4);
				break;
		case 4: decena=(a%100)/10;
				unidad=a%10;
				EscribeLCD_n8((a%10000)/100,2);
				EnviaDato(decena+48);
				HabilitaLCD();
				RetardoLCD(4);
				EnviaDato(unidad+48);
		...
		case 5: centena=a/10000;
				...
				RetardoLCD(4);
				unidad=decena%100;
                EscribeLCD_n8(unidad,2);
                //EscribeLCD_n16(a%10000,4);
				break;
		default: break;
	}	
}
